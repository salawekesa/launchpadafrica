...
import { Home, Rocket, Trophy, User, Menu, X, Sun, Moon, Upload, FolderKanban, MessageCircle } from 'lucide-react';
...
const navItems = [
  ...
  { path: '/community', label: 'Community', icon: MessageCircle, public: true },
  { path: '/my-hackathon', label: 'Create project', icon: FolderKanban, public: false },
      ...
      <div className="container flex h-16 items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden md:flex items-center gap-2">
            {isAuthenticated ? (
              <>
                {(user?.role === 'builder' || user?.role === 'community') && (
                  <Link to="/submit">
